...
def get_all_custom_fields() -> dict:
    ...
    ticket_custom_fields = __treatment_ticket_custom_fields(zendesk_ticket_custom_fields)
...
def __treatment_ticket_custom_fields(ticket_custom_fields: dict) -> dict:
    ...
    for field in ticket_custom_fields['ticket_fields']:
        ...
        if custom_field_options:
            options = [{'id': option['id'], 'name': option['name'], 'value': option['value']} for option in custom_field_options]
